    ...
    <div className="min-h-screen flex">
      <aside className="w-64 shrink-0 border-r border-white/10 bg-slate-900/40 p-4 flex flex-col">
        <div className="flex items-center gap-2.5 px-2 py-3 mb-4">
          <div className="grid h-9 w-9 place-items-center rounded-xl bg-brand-600 font-bold">Y</div>
          <div>
            <div className="text-sm font-semibold leading-tight">Yurist paneli</div>
            <div className="text-xs text-slate-400">Maʼlumotnoma</div>
          </div>
        </div>

        <nav className="flex-1 space-y-1">
          <NavLink href="/">Boshqaruv</NavLink>
          <NavLink href="/arizalar/yangi">Yangi ariza</NavLink>
        </nav>
